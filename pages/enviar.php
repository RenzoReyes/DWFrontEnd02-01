...
$nombre = isset($_POST['nombre']) ? Filtro($_POST['nombre']) : ''; //isset(determina si viene un valor) recibe el campo y lo guarda con una variable y pasa por filtro pa sacar carateres especiales 
